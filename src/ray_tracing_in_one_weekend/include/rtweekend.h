...
Float3 random_float3(UInt &seed, const Float& min, const Float& max) {
...
class material;
luisa::vector<luisa::shared_ptr<material>> materials; // Global Material Table
